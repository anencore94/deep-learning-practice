...
LSTM layer + Dense layer 모델로
x_5 를 예측하는 모델

Long time memory 의 보존을 위해 cell state 의 time 에 따른 지속적 공유

# LSTM, GRU 모두 simple.py 의 SimpleRNN Layer 를 keras 내장 LSTM, GRU layer 로 변경시켜주면 끝
# TODO) 추후 성능 차이를 확인할 수 있는 public data 로 테스트
"""
